...
% ID: 9521010039
% Project 2
% File name: Am_Modulator.m(by a Sinusoidal function input)
% Date: 1.10.2019
% Kashan University
...
SNR=10000000; %signal to noise ratio
...
f0=1000; % Hz, f0= signal frequency
t=-2:TS:2;  % time variable
B=1;          % AM Mod. index
f=-FS/2:FS/n:(FS/2-FS/n);% frequency variable
%%%%%%% product modulator%%%%%%
massage=3*cos(2*pi*f0*t);  
...
demod_signal =5*(( filter(b,a,RX_signal).*g)-1);     % Apply lowpass filter
