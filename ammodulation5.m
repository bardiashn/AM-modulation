...
% ID: 9521010039
% Project 2
% File name: Am_Modulator.m(by rectpulse input)
% Date: 1.10.2019
% Kashan University
...
SNR=0.001; %signal to noise ratio
...
%%%%%%% product modulator%%%%%%
t = -0.1:TS:0.1;
massage=[zeros(1,0.06/TS)  ones(1,0.08/TS) zeros(1,0.06/TS+1)];
...
Sigma_n2=0 ; % noise variance (set Sigma_n2=0 for No noise)
...
% low pass filter%
W=1000; % bandwidth of Message Signal
b = fir1(400,W/(FS/2),'low'); % Lowpass filter design
demod_signal=(filter(b,1,RX_signal)-50)/50; % x(t) = Message Signal with Bandwidth W
